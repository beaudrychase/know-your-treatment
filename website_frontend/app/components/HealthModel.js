	...
	render() {
		return(
			<div class="container">
				...
				<h5>Diagnosis</h5>
				<p style={{paddingLeft: '20px'}}>{(this.state.diagnosis === '' || this.state.diagnosis === null) ? "No data available." : this.state.diagnosis}</p>

				<h5>Symptoms</h5>
				<p style={{paddingLeft: '20px'}}>{(this.state.symptoms === '' || this.state.symptoms === null) ? "No data available." : this.state.symptoms }</p>

				<h5>Prevention</h5>
				<p style={{paddingLeft: '20px'}}>{(this.state.prevention === '' || this.state.prevention === null) ? "No data available." : this.state.prevention}</p>

				<h5>Transmission</h5>
				<p style={{paddingLeft: '20px'}}>{(this.state.transmission === '' || this.state.transmission === null) ? "No data available." : this.state.transmission}</p>

				<h5>Treatment</h5>
				<p style={{paddingLeft: '20px'}}>{(this.state.treatment_text === '' || this.state.treatment_text === null) ? "No data available." : this.state.treatment_text}</p>
				<ListGroup>
